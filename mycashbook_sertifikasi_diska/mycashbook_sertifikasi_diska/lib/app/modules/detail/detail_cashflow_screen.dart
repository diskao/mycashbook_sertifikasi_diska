...
import 'package:mycashbook_sertifikasi_diska/app/modules/detail/widgets/cash_flow_widget.dart';
              ...
              children: [
                Obx(
                  () => Column(
                    ...
                    children: [
                      if (controller.cashflows.length > 0)
                        // Pengecekan jika cashflows tidak kosong
